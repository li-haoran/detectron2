...
__all__ = [ "build_conl_resnet_backbone",]
...
class BasicBlock(CNNBlockBase):
    ...
    def __init__(self, in_channels, out_channels, *, stride=1, norm="BN",plugin=None):
        """
        Args:
...
def build_conl_resnet_backbone(cfg, input_shape):
    ...
    plugin_stage_idx=[
        {"res2": 2, "res3": 3, "res4": 4, "res5": 5}[f] for f in conl_stages if f != "stem"
    ]
