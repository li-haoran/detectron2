...
from pointscollection.head import PointsCollectionHead,ClsHead,instanceMask,pointRefine
from pointscollection.data import Targets,_postprocess
from pointscollection.loss import chamfer_loss,normlize_chamfer_loss,emd_l1_loss2

import matplotlib.pyplot as plt


@META_ARCH_REGISTRY.register()
class PointsCollectionRefine(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        self.ins_head=pointRefine(cfg,ins_features_shape)
    ...
    def losses(
        ...
        location=(pred_location+gt_belongs[:,1:].view(N,1,2))*self.classify_feature_strides[-1]/self.ins_feature_strides[0]
    ...
    def inference(self, pred_digits,pred_points,ins_feature,images):
        ...
        for img_idx in range(batch):
            ...
            pred_delta=self.ins_head(ins_feature,location,batch_index)
            real_npoints+=(pred_delta[:,:,(1,0)]*self.points_feature_strides[-1])
